    ...
    <form action="{{ route('trainings.update', $training->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <select name="penduduk_id" class="form-control">
                @foreach ($penduduks as $penduduk)
                    <option value="{{ $penduduk->id }}" {{ $training->penduduk_id == $penduduk->id ? 'selected' : '' }}>{{ $penduduk->nama }}</option>
                @endforeach
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <select name="ada_tempat_berteduh_tetap" class="form-control">
                <option value="1" {{ $training->ada_tempat_berteduh_tetap == 1 ? 'selected' : '' }}>Ya</option>
                <option value="0" {{ $training->ada_tempat_berteduh_tetap == 0 ? 'selected' : '' }}>Tidak</option>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <select name="krt_bekerja" class="form-control">
                <option value="1" {{ $training->krt_bekerja == 1 ? 'selected' : '' }}>Ya</option>
                <option value="0" {{ $training->krt_bekerja == 0 ? 'selected' : '' }}>Tidak</option>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <select name="pernah_khawatir_makan" class="form-control">
                <option value="1" {{ $training->pernah_khawatir_makan == 1 ? 'selected' : '' }}>Ya</option>
                <option value="0" {{ $training->pernah_khawatir_makan == 0 ? 'selected' : '' }}>Tidak</option>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <select name="pengeluaran_pangan_lebih_dari_70" class="form-control">
                <option value="1" {{ $training->pengeluaran_pangan_lebih_dari_70 == 1 ? 'selected' : '' }}>Ya</option>
                <option value="0" {{ $training->pengeluaran_pangan_lebih_dari_70 == 0 ? 'selected' : '' }}>Tidak</option>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <select name="ada_pengeluaran_pakaian_dalam_setahun" class="form-control">
                <option value="1" {{ $training->ada_pengeluaran_pakaian_dalam_setahun == 1 ? 'selected' : '' }}>Ya</option>
                <option value="0" {{ $training->ada_pengeluaran_pakaian_dalam_setahun == 0 ? 'selected' : '' }}>Tidak</option>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <select name="lantai_terbuat_dari_tanah" class="form-control">
                <option value="1" {{ $training->lantai_terbuat_dari_tanah == 1 ? 'selected' : '' }}>Ya</option>
                <option value="0" {{ $training->lantai_terbuat_dari_tanah == 0 ? 'selected' : '' }}>Tidak</option>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <select name="dinding_terbuat_dari_bambu_kawat_kayu" class="form-control">
                <option value="1" {{ $training->dinding_terbuat_dari_bambu_kawat_kayu == 1 ? 'selected' : '' }}>Ya</option>
                <option value="0" {{ $training->dinding_terbuat_dari_bambu_kawat_kayu == 0 ? 'selected' : '' }}>Tidak</option>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <select name="punya_fasilitas_buang_air_sendiri" class="form-control">
                <option value="1" {{ $training->punya_fasilitas_buang_air_sendiri == 1 ? 'selected' : '' }}>Ya</option>
                <option value="0" {{ $training->punya_fasilitas_buang_air_sendiri == 0 ? 'selected' : '' }}>Tidak</option>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <select name="listrik_pln_450_watt" class="form-control">
                <option value="1" {{ $training->listrik_pln_450_watt == 1 ? 'selected' : '' }}>Ya</option>
                <option value="0" {{ $training->listrik_pln_450_watt == 0 ? 'selected' : '' }}>Tidak</option>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <select name="rekomendasi_kelayakan" class="form-control">
                <option value="Layak" {{ $training->rekomendasi_kelayakan == 'Layak' ? 'selected' : '' }}>Layak</option>
                <option value="Tidak Layak" {{ $training->rekomendasi_kelayakan == 'Tidak Layak' ? 'selected' : '' }}>Tidak Layak</option>
            </select>
        </div>
